...
export class MultilingualSettingsDto {
    @ApiProperty({
        description:
            "Printing ticket template with translations for each language. Only specify languages you want to update. Supports HTML formatting with placeholders: &categoryShortName, &number, &date, &time. Set to null or empty string to delete/reset a specific language setting.",
        example: {
